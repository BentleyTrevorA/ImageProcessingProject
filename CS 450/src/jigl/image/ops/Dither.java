	...
	protected Image apply(ColorImage image) {
		...
		for (int x = 0; x < realImage.X(); x++) {
			for (int y = 0; y < realImage.Y(); y++) {
				...
				try {
					temp2[0] = (float) ((float) diff[0] * 7.0 / 16.0);
					temp2[1] = (float) ((float) diff[1] * 7.0 / 16.0);
					temp2[2] = (float) ((float) diff[2] * 7.0 / 16.0);
					imageMap.add(x + 1, y, temp2);
				} catch (Exception e) {
				}
				try {
					temp2[0] = (float) ((float) diff[0] * 3.0 / 16.0);
					temp2[1] = (float) ((float) diff[1] * 3.0 / 16.0);
					temp2[2] = (float) ((float) diff[2] * 3.0 / 16.0);
					imageMap.add(x - 1, y + 1, temp2);
				} catch (Exception e) {
				}
				try {
					temp2[0] = (float) ((float) diff[0] * 5.0 / 16.0);
					temp2[1] = (float) ((float) diff[1] * 5.0 / 16.0);
					temp2[2] = (float) ((float) diff[2] * 5.0 / 16.0);
					imageMap.add(x, y + 1, temp2);
				} catch (Exception e) {
				}
				try {
					temp2[0] = (float) ((float) diff[0] * 1.0 / 16.0);
					temp2[1] = (float) ((float) diff[1] * 1.0 / 16.0);
					temp2[2] = (float) ((float) diff[2] * 1.0 / 16.0);
					imageMap.add(x + 1, y + 1, temp2);
				} catch (Exception e) {
				}
				temp3[0] = (int) best[0];
