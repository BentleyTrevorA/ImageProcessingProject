...
public class Shift extends SimpleOperator {
	 ...
	 * @param wrap NOWRAP= no wrap WRAP=wrap.
	 */
	...
	protected Image apply(ColorImage image) {
		...
		temp.setPlane(0, (GrayImage) apply(image.plane(0)));
		temp.setPlane(1, (GrayImage) apply(image.plane(1)));
		temp.setPlane(2, (GrayImage) apply(image.plane(2)));
		return temp;
	...
	protected Image apply(RealColorImage image) {
		...
		temp.setPlane(0, (RealGrayImage) apply(image.plane(0)));
		temp.setPlane(1, (RealGrayImage) apply(image.plane(1)));
		temp.setPlane(2, (RealGrayImage) apply(image.plane(2)));
		return temp;
