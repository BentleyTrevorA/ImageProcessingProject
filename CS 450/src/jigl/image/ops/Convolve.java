...
public class Convolve extends SimpleOperator {
	...
	/**
	 * Initilizes Convolve. Assumes that the width and height of <code>k</code> are odd, and the
	...
	protected Image apply(ColorImage image) throws ImageNotSupportedException {
		...
		image2.setPlane(0, (GrayImage) apply(image.plane(0)));
		image2.setPlane(1, (GrayImage) apply(image.plane(1)));
		image2.setPlane(2, (GrayImage) apply(image.plane(2)));
		return image2;
	}
	...
	protected Image apply(ColorImage image, ROI roi) throws ImageNotSupportedException {
		ColorImage image2 = new ColorImage(image.X(), image.Y());
		image2.setPlane(0, (GrayImage) apply(image.plane(0), roi));
		image2.setPlane(1, (GrayImage) apply(image.plane(1), roi));
		image2.setPlane(2, (GrayImage) apply(image.plane(2), roi));
		return image2;
	}
	...
	protected Image apply(RealColorImage image) {
		...
		image2.setPlane(0, (RealGrayImage) apply(image.plane(0)));
		image2.setPlane(1, (RealGrayImage) apply(image.plane(1)));
		image2.setPlane(2, (RealGrayImage) apply(image.plane(2)));
		return image2;
	}
	...
	protected Image apply(RealColorImage image, ROI roi) {
		RealColorImage image2 = new RealColorImage(image.X(), image.Y());
		image2.setPlane(0, (RealGrayImage) apply(image.plane(0), roi));
		image2.setPlane(1, (RealGrayImage) apply(image.plane(1), roi));
		image2.setPlane(2, (RealGrayImage) apply(image.plane(2), roi));
		return image2;
	}
