...
public class ImageSequence {
	 ...
	 * are supported.
	 */
	public void add(jigl.image.Image image) throws ImageNotSupportedException {
	...
	public void add(jigl.image.Image image, int location) throws ImageNotSupportedException {
		if (image instanceof GrayImage || image instanceof RealGrayImage)
