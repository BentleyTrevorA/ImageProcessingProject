...
/** TiledComplexMIPMap is the frequency-domain version of {TileMIPMap}. */
public class TiledComplexMIPMap {
	...
	class Threader extends Thread {
		...
		public void run() {
			...
			if (m_xBuff == 0 && m_yBuff == 0) {
				...
				m_reducedImage.setInterpolationMethod(InterpolatedRealColorImage.LINEAR);
			} else {
	...
	public TiledComplexMIPMap(RealColorImage image, int n) {
		...
		m_imageArray[0].setInterpolationMethod(InterpolatedRealColorImage.LINEAR);
