...
public class DifferentialGeometry {
	 ...
	 */
	public RealGrayImage calcIx() throws jigl.image.ImageNotSupportedException {

		IxImage = new RealGrayImage(image.X(), image.Y());
		try {
			ImageKernel ik = new ImageKernel(ImageKernel.SOBEL_X);
			Convolve c = new Convolve(ik);
			IxImage = (RealGrayImage) c.apply((Image) image);
		} catch (Exception e) {
	 ...
	 */
	public RealGrayImage calcIy() throws jigl.image.ImageNotSupportedException {

		IyImage = new RealGrayImage(image.X(), image.Y());
		try {
			ImageKernel ik = new ImageKernel(ImageKernel.SOBEL_Y);
			Convolve c = new Convolve(ik);
			IyImage = (RealGrayImage) c.apply((Image) image);
		} catch (Exception e) {
			System.out.println("Internal Jigl ImageKernel error.");
			return null;
		}
	 ...
	 */
	public RealGrayImage calcIxx() throws jigl.image.ImageNotSupportedException {

		IxxImage = new RealGrayImage(image.X(), image.Y());
		try {
			ImageKernel ik = new ImageKernel(ImageKernel.D_XX);
			Convolve c = new Convolve(ik);
			IxxImage = (RealGrayImage) c.apply((Image) image);
		} catch (Exception e) {
			System.out.println("Internal Jigl ImageKernel error.");
			return null;
		}
	 ...
	 */
	public RealGrayImage calcIyy() throws jigl.image.ImageNotSupportedException {

		IyyImage = new RealGrayImage(image.X(), image.Y());
		try {
			ImageKernel ik = new ImageKernel(ImageKernel.D_YY);
			Convolve c = new Convolve(ik);
			IyyImage = (RealGrayImage) c.apply((Image) image);
		} catch (Exception e) {
			System.out.println("Internal Jigl ImageKernel error.");
			return null;
		}
	 ...
	 */
	public RealGrayImage calcIxy() throws jigl.image.ImageNotSupportedException {

		IxyImage = new RealGrayImage(image.X(), image.Y());
		try {
			ImageKernel ik = new ImageKernel(ImageKernel.D_YY);
			Convolve c = new Convolve(ik);
			IxyImage = (RealGrayImage) c.apply((Image) image);
		} catch (Exception e) {
			System.out.println("Internal Jigl ImageKernel error.");
			return null;
		}
