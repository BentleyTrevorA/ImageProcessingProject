...
class Scaler {
	 ...
	 */
	public GrayImage calcIx(GrayImage im) throws jigl.image.ImageNotSupportedException {
		GrayImage gimage = null;
		try {
			ImageKernel ik = new ImageKernel(ImageKernel.SOBEL_X);
			Convolve c = new Convolve(ik);
			gimage = (GrayImage) c.apply((Image) im);
		} catch (Exception e) {
	 ...
	 */
	public GrayImage calcIy(GrayImage im) throws jigl.image.ImageNotSupportedException {
		GrayImage gimage = null;
		try {
	 ...
	 */
	public GrayImage calcIxx(GrayImage im) throws jigl.image.ImageNotSupportedException {
		GrayImage gimage = null;
		try {
	 ...
	 */
	public GrayImage calcIyy(GrayImage im) throws jigl.image.ImageNotSupportedException {
		GrayImage gimage = null;
		try {
	 ...
	 */
	public GrayImage calcIxy(GrayImage im) throws jigl.image.ImageNotSupportedException {
		GrayImage gimage = null;
		try {
			ImageKernel ik = new ImageKernel(ImageKernel.D_XY);
			Convolve c = new Convolve(ik);
			gimage = (GrayImage) c.apply((Image) im);
		} catch (Exception e) {
			System.out.println("Internal Jigl ImageKernel error.");
