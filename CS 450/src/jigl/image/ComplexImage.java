...
public class ComplexImage implements Image {
	...
	public Image copy() {
		...
		c.real = (RealGrayImage) real.copy();
		c.imag = (RealGrayImage) imag.copy();
	...
	public Image copy(ROI roi) {
		...
		c.real = (RealGrayImage) real.copy(roi);
		c.imag = (RealGrayImage) imag.copy(roi);
	 ...
	 * @param roi Region of Interest
	 */
	public final void set(int x, int y, float r, float i, ROI roi) {
		real.set(x, y, r, roi);
		imag.set(x, y, i, roi);
	}
