...
import jigl.image.InterpolatedColorImage;
import jigl.image.InterpolatedGrayImage;
import jigl.image.InterpolatedRealColorImage;
import jigl.image.InterpolatedRealGrayImage;
...
//	protected InterpolatedImage interpImg;
	...
	@param mapper the image to apply the transformation
	@param interpolationMethod the way to interpolate (0=NEIGHBOR 1=LINEAR 2=CUBIC)*/
  	public Mapper(PointMapper mapper, int interpolationMethod) throws ImageNotSupportedException
	{
		m_mapper = mapper;
